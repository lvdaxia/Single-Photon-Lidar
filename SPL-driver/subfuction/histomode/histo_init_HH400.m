[MAXHISTBINS,FLAG_OVERFLOW, dev, Resolution_ps,Syncrate,NumInpChannels]=histomode_init_HH_400(Mode,Binning);

function [MAXHISTBINS,FLAG_OVERFLOW, dev, Resolution,Syncrate,NumInpChannels]=histomode_init_HH_400(Mode,Binning)
% [TTREADMAX,FLAG_FIFOFULL,dev, Resolution,laser_period,Countrate0] 
