function [TTREADMAX,FLAG_FIFOFULL,dev,Resolution,laser_period] = Initialization_TH_260(Tacq, Mode)
    % Constants from hhdefin.h

    REQLIBVER   =     '3.2';     % this is the version this program expects
    MAXDEVNUM   =         4;
    TTREADMAX   =    131072;     % 128K event records 2e17
    MODE_HIST   =         0;
    MODE_T2	    =         2;
    MODE_T3	    =         3;
...
%     Mode          = MODE_T3; % you can change this
    ...
    Binning       = 0;       %  you can change this (observe mode!)  分辨率
   
    %tacq单位为ms 1e3为1s 可获得frequency=1e4个数据
    ...
    SyncCFDLevel  = -91;      %  you can change this
    InputCFDZeroX = -10;      %  you can change this
    InputCFDLevel = -259;      %  you can change this
